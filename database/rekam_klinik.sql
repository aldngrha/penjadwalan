...
--
-- Host: localhost:3306
-- Generation Time: Jan 04, 2025 at 05:43 AM
...
CREATE TABLE `tb_resep` (
  ...
  `harga_obt` int NOT NULL,
  `jumlah_obt` int NOT NULL,
  `subharga_obt` int NOT NULL,
  `tarif_dkt` int NOT NULL,
  `total` int NOT NULL,
...
--
ALTER TABLE `tb_poli`
  MODIFY `id_poli` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
